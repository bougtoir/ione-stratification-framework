...
This simulation study is reported following the ADEMP framework (Aims, Data-generating mechanisms, Estimands, Methods, Performance measures) as recommended by Morris, White, and Crowther [25]. All analyses were conducted in Python 3.11.
...
- **Gaussian mixture model (GMM):** A finite mixture model with K Gaussian components is fitted to the standardised covariate space X₁–X₁₀. Component assignments define strata. This represents the latent class analysis approach to hidden subgroup discovery [22].
...
- **Adjusted Rand Index (ARI)** [26]: Measures agreement between estimated strata and true Z-based clusters, corrected for chance. Range [−1, 1]; 1 = perfect agreement; 0 = chance level.
...
- **Normalised Mutual Information (NMI)** [27]: An information-theoretic measure of cluster agreement. Range [0, 1].
...
3. VanderWeele TJ, Knol MJ. A tutorial on interaction. *Epidemiol Methods*. 2014;3(1):33–72.
4. VanderWeele TJ, Shpitser I. On the definition of a confounder. *Ann Stat*. 2013;41(1):196–220.
5. Simpson EH. The interpretation of interaction in contingency tables. *J R Stat Soc Ser B*. 1951;13(2):238–41.
6. Rojanaworarit C. Misleading epidemiological and statistical evidence in the presence of Simpson's paradox: an illustrative study using simulated scenarios. *J Med Life*. 2020;13(1):37–44.
...
21. Tchetgen Tchetgen EJ, Ying A, Cui Y, Shi X, Miao W. An introduction to proximal causal inference. *Stat Sci*. 2024;39(3):375–90.
22. McLachlan GJ, Peel D. *Finite Mixture Models*. New York: Wiley; 2000.
23. Hayes-Larson E, Kezios KL, Mooney SJ, Lovasi G. Who is in this study, anyway? Guidelines for a useful Table 1. *J Clin Epidemiol*. 2019;114:125–32.
24. Higgins JPT, Thompson SG. Quantifying heterogeneity in a meta-analysis. *Stat Med*. 2002;21(11):1539–58.
...
27. Strehl A, Ghosh J. Cluster ensembles—a knowledge reuse framework for combining multiple partitions. *J Mach Learn Res*. 2002;3:583–617.
